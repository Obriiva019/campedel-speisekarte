...
const CATEGORIES = [
  {
    ...
    items: [
      { id: 'salad',     name: { de: 'Gemischter Salat', it: 'Insalata mista', en: 'Mixed salad' }, p: '6,00', d: ['veg','vegan','gf','lf'] },
      { id: 'brett',     name: { de: 'Bretteljause mit Speck und Käse', it: 'Tagliere di speck con formaggi', en: 'Speck and cheese platter' }, p: '15,90', d: ['gf'], h: true,
      ...
      { id: 'tatar',     name: { de: 'Avokado-Tomatentatar mit Burrata und Wildkräutersalat',
                                  ...
                                  en: 'Avocado & tomato tartare with burrata and wild herb salad' }, p: '16,90', d: ['veg'] },
    ],
  },
  {
    id: 'soup',
    ...
    items: [
      { id: 'knoedel',   name: { de: 'Speckknödelsuppe', it: 'Canederli allo speck in brodo', en: 'Speck dumpling soup' }, p: '12,90', d: [], h: true, hm: true },
      { id: 'spargel',   name: { de: 'Spargelcremesuppe mit Brotcroutons', it: 'Crema di asparagi con crostini', en: 'Cream of asparagus soup with croutons' }, p: '9,90', d: ['veg'] },
    ],
  },
  {
    id: 'primi',
    ...
    items: [
      { id: 'schlutz',   name: { de: 'Hausgemachte Schlutzkrapfen mit Butter und Reibkäse',
        ...
        p: '15,50', d: ['veg'], hm: true, photo: 'img/schlutzkrapfen.jpg',
      ...
      { id: 'knoedeltris', name: { de: 'Knödeltris mit Butter und Reibkäse',
                                    ...
                                    en: 'Trio of dumplings with butter and grated cheese' }, p: '16,50', d: ['veg'], hm: true },
      { id: 'tortelloni',  name: { de: 'Hausgemachte Tortelloni mit Ricottafüllung, Bärlauch und Spargelragout',
                                    ...
                                    en: 'Homemade tortelloni with ricotta, wild garlic and asparagus ragout' }, p: '16,50', d: ['veg'], hm: true },
      { id: 'risotto',     name: { de: 'Brennnessel-Risotto mit frischem Spargel',
                                    it: 'Risotto alle ortiche con asparagi freschi',
                                    en: 'Nettle risotto with fresh asparagus' }, p: '16,90', d: ['veg','gf'] },
    ],
  },
  {
    id: 'main',
    ...
    items: [
      { id: 'entrecote',  name: { de: 'Entrecote vom Rind mit Kartoffelspalten, Salat und Kräuterbutter',
                                   ...
                                   en: 'Beef entrecote with potato wedges, mixed salad and herb butter' }, p: '28,50', d: ['gf'], h: true },
      { id: 'burger',     name: { de: '„Campedèl-Burger" vom eigenen Grauvieh',
                                   it: '«Campedèl Burger» con carne dei nostri bovini',
                                   en: '"Campedèl Burger" with our own grey-cattle beef' }, p: '18,90', d: [], h: true, hm: true,
      ...
      { id: 'pepper',     name: { de: 'Pfeffersteak „Campedèl", medium, mit Röstkartoffeln und Salat',
                                   ...
                                   en: '"Campedèl" pepper steak, medium, with roasted potatoes and salad' }, p: '34,00', d: ['gf'], h: true },
      { id: 'gulasch',    name: { de: 'Hofeigenes Rindsgulasch mit zwei Speckknödeln',
                                   ...
                                   en: 'Homemade beef goulash with two speck dumplings' }, p: '19,50', d: [], h: true, hm: true },
      { id: 'wiener',     name: { de: 'Wienerschnitzel vom Hofkalb mit Pommes und Preiselbeermarmelade',
                                   ...
                                   en: 'Viennese schnitzel of farm veal with fries and cranberry jam' }, p: '22,90', d: [], h: true },
      { id: 'spargel-main', name: { de: 'Frische Stangenspargel mit Hausschinken, Naturkartoffeln und Bozner Sauce',
                                     ...
                                     en: 'Fresh white asparagus with homemade ham, boiled potatoes and Bozner sauce' }, p: '23,90', d: ['gf'], h: true },
    ],
  },
  {
    id: 'kids',
    ...
    items: [
      { id: 'k-wiener', name: { de: 'Wienerschnitzel vom Hofkalb mit Pommes', it: 'Cotoletta di vitello del maso con patatine', en: 'Veal schnitzel with fries' }, p: '15,00', d: [], h: true },
      { id: 'k-spag',   name: { de: 'Spaghetti mit Tomatensauce oder Ragu', it: 'Spaghetti al pomodoro o ragù', en: 'Spaghetti with tomato or ragù' }, p: '9,50', d: ['veg'] },
      { id: 'k-wurst',  name: { de: 'Grillwurst mit Pommes', it: 'Würstel alla griglia con patatine', en: 'Grilled sausage with fries' }, p: '9,50', d: [] },
      { id: 'k-fries',  name: { de: 'Pommes frites', it: 'Patatine fritte', en: 'French fries' }, p: '6,00', d: ['veg','vegan'] },
    ],
  },
  {
    id: 'dessert',
    ...
    items: [
      { id: 'buchteln', name: { de: 'Buchteln mit Vanillesauce', it: 'Buchteln con crema alla vaniglia', en: 'Buchteln with vanilla sauce' }, p: '9,50', d: ['veg'], hm: true },
      { id: 'icehimb',  name: { de: 'Vanilleeis mit heißen Himbeeren', it: 'Gelato alla vaniglia con lamponi caldi', en: 'Vanilla ice cream with warm raspberries' }, p: '8,50', d: ['veg','gf'] },
      { id: 'sorbet',   name: { de: 'Zitronensorbet mit Limoncello', it: 'Sorbetto al limone con Limoncello', en: 'Lemon sorbet with Limoncello' }, p: '7,90', d: ['veg','vegan','gf','lf'] },
      { id: 'strudel',  name: { de: 'Apfelstrudel mit Vanillesauce', it: 'Strudel di mele con crema alla vaniglia', en: 'Apple strudel with vanilla sauce' }, p: '5,90', d: ['veg'], hm: true },
      { id: 'creme',    name: { de: 'Crème brûlée mit frischen Erdbeeren', it: 'Crème brûlée con fragole fresche', en: 'Crème brûlée with fresh strawberries' }, p: '7,90', d: ['veg','gf'] },
    ],
  },
];
